 ...
 */
    //个人资料页面
define(['app','controllers/HealthModuleViewController','controllers/ConsultRecordsController'], function (app,health,process) {
    app.controller('RecordsConsultController', ['$scope', '$cookieStore','Ajax','$location', function ($scope, $cookieStore,Ajax,$location) {
        var search = $location.search();
        YB.log(search);
        if(!search.recordType){
            $location.search('recordType',3);
            $location.replace();
        }
        //跳到健康档案首页
