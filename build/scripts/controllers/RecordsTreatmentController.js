 ...
 */
    //个人资料页面
define(['app','controllers/HealthModuleViewController','controllers/MedicalRecordsTreatmentController'], function (app,health,check) {
    app.controller('RecordsTreatmentController', ['$scope','$rootScope', '$cookieStore', '$controller','$compile','$timeout','Ajax','$location','$window',function ($scope, $rootScope,$cookieStore,$controller,$compile,$timeout,Ajax,$location,$window) {
